...
define('RSSSL_KEY', 'wr5UB4ThqIFhuKgEShr3k8Ire9HYCImIQdvGLBa695IcxOzfN7vxcvfiq01F217M');
...
define( 'WPCACHEHOME', '/b2s2pwakeup/www/wp-content/plugins/wp-super-cache/' );
define( 'DB_NAME', 'b2s2pwakeup' );

/** Database username */
define( 'DB_USER', 'b2s2pwakeup' );

/** Database password */
define( 'DB_PASSWORD', 'epqm0913!' );
